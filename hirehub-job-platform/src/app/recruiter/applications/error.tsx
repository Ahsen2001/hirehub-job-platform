...
export default function RecruiterApplicationsError({
  reset,
}: {
  error: Error;
  reset: () => void;
  ...
  return (
    <>
      <DashboardPageHeader
        ...
        description="Something went wrong while loading applications."
      />
      <div className="rounded-card border border-red-100 bg-red-50 p-5 text-sm font-medium text-danger">
        <p>Unable to load the application pipeline right now.</p>
        <button
          type="button"
          onClick={reset}
